  ...
  new FormDefinition(
    {
      ...
      theme_group_ids: {
        label: vm.$t('theme_groups'),
        type: 'autocomplete-multiple',
        placeholder: vm.$t('reports_theme_group_selector'),
        url: '/api/theme/theme_groups/?page_size=200',
        optionLabelAttribute: 'description',
        excludeSelectedValuesByField: 'id',
        styleClasses: 'col-lg-8 col-6',
      },
      what: {
        type: 'toggle',
        default: true,
        disabled: true,
        label: vm.$t('reports_what'),
        styleClasses: 'text-center col pr-0',
      },
      who: {
        type: 'toggle',
        default: false,
        label: vm.$t('reports_who'),
        styleClasses: 'text-center col pl-0 pr-0',
      },
      how: {
        type: 'toggle',
        default: false,
        label: vm.$t('reports_how'),
        styleClasses: 'text-center col pl-0',
      },
      area_id: {
        type: 'autocomplete',
        inputType: 'number',
...
export default {
  ...
  props: {
    title: {
      type: String,
      default: 'reports_what_who_how',
    },
    url: {
      type: String,
      default: '/api/reports/quequicom/',
    },
    definition: {
      type: Function,
  ...
  data() {
    return {
      alternateRequirementsIntervalId: null,
    }
  },
  computed: {
    timeoutErrorText() {
      return this.$t('record_card_excel_error_msg_timeout')
    },
  },
  created() {
