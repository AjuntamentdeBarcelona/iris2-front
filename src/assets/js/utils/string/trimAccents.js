...
export default function trimAccents(str) {
...
/**
 * Unaccented comparission of two strings.
 * @param {} str
 * @return {Boolean} True if a string is contained in the other, case and accent insensitive
 */
export function iUnaccentContains(text, search) {
  return (
    trimAccents(text)
      .toLowerCase()
      .indexOf(trimAccents(search).toLowerCase()) > -1
  )
}
